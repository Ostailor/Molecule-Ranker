  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slatewash-50 px-4 py-10">
      <div className="w-full max-w-2xl">
        ...
        <Card>
          <CardHeader title="Privacy placeholder" eyebrow="Placeholder until Release V0.2" />
          <CardBody>
            {/* PLACEHOLDER_V0_1_PRIVACY: replace with approved privacy notice for Release V0.2. */}
            <p className="text-sm leading-6 text-ink-600">
              This placeholder exists so pilot reviewers can navigate the mock login flow without broken links. The V0.1
              placeholder app does not store user data.
            </p>
            <div className="mt-4">
