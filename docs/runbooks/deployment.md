...
Deploy molecule-ranker V1.2 as an internal research platform MVP with hosted
auth, RBAC, jobs, audit logs, and artifact storage enabled.

## Prerequisites

- A reviewed V1.2 release package.
...
- `/version` reports `1.2.0` and V1 contract identifiers.
