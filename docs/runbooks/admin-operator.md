...
This runbook is for V1.3 internal hosted deployments. molecule-ranker is not a
...
The version endpoint must report `1.3.0`, `api.v1`, `artifacts.v1`,
...
Backup cadence and restore drills are release gates for V1.3.
