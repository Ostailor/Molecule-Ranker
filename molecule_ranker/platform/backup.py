    ...
    with TemporaryDirectory() as tmp:
        ...
        with zipfile.ZipFile(output_path, mode="w", compression=zipfile.ZIP_DEFLATED) as archive:
            ...
            manifest = {
                ...
                "disaster_recovery": {
                    "v2_drill_supported": True,
                    "manifest_hash_verification": True,
                    "restore_hash_verification": True,
                    "secrets_excluded_by_default": True,
                    "cache_excluded_by_default": not include_cache,
                    "codex_transcripts_excluded_by_default": not include_codex_transcripts,
                },
