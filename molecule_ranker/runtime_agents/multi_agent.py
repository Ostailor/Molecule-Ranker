...
class MultiAgentScientificOrchestrator:
    """Coordinate V2.6 specialist Codex subagents through runtime-agent controls."""
...
def default_specialist_agents() -> list[SpecialistAgentSpec]:
    return [
        ...
        _agent(
            "biologics-engineer",
            "biologics_engineering",
            "Biologics Engineering Agent",
            "Reviews antibody and biologics candidates, critiques generated antibody "
            "hypotheses, and checks sequence, novelty, and developability summaries.",
            [
                "biologics_retrieval",
                "antibody_validation",
...
_CATEGORY_PATTERNS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"\bbiologic|antibody|antigen|cdr|novelty", re.I), "biologics_reports"),
