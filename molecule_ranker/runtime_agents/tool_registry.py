...
def _default_tool_specs() -> list[RuntimeToolSpec]:
    return [
        ...
        _spec(
            "retrieve_biologics",
            "biologics_retrieval",
            "Retrieve source-backed biologic and antibody candidates.",
            "artifact_write",
            "biologics:analyze",
            "molecule_ranker.biologics.retrieval.retrieve_existing_biologics",
            policy_tags=["source_backed", "no_sequence_fabrication"],
        ),
        _spec(
            "validate_antibody_sequence",
            "antibody_validation",
            "Run deterministic antibody sequence validation.",
            "artifact_write",
            "biologics:analyze",
            "molecule_ranker.biologics.validation.validate_antibody_sequence",
            policy_tags=["deterministic_validation", "generated_antibody_gate"],
        ),
        _spec(
            "assess_antibody_developability",
            "antibody_developability",
            "Assess antibody developability heuristic summaries.",
            "artifact_write",
            "biologics:analyze",
            "molecule_ranker.biologics.developability.assess_antibody_developability",
            policy_tags=["heuristic_triage", "no_manufacturability_claim"],
        ),
        _spec(
            "assess_antibody_novelty",
            "antibody_novelty",
            "Assess antibody novelty against configured sources.",
            "artifact_write",
            "biologics:analyze",
            "molecule_ranker.biologics.novelty.assess_antibody_novelty",
            policy_tags=["source_limited_novelty", "no_global_novelty_claim"],
        ),
        _spec(
            "build_biologics_report",
            "biologics_reports",
            "Build antibody and biologics report-card summaries.",
            "artifact_write",
            "biologics:analyze",
            "molecule_ranker.biologics.reports.build_biologic_report_card",
            policy_tags=["report_only", "generated_antibody_warning_required"],
        ),
        _spec(
        ...
        _spec(
            ...
            "structure",
            "Review optional structure workflow artifacts without creating binding claims.",
            "none",
            "structure:read",
            "molecule_ranker.structure.reports",
        ),
        _spec(
            "run_structure_validation",
            "structure",
            "Run deterministic structure workflow validation.",
            "artifact_write",
            "structure:run",
            "molecule_ranker.validation.structure",
        ),
        _spec(
            "build_model_dataset",
            "model",
            "Build endpoint-specific predictive model datasets.",
            "artifact_write",
            "model:run",
            "molecule_ranker.models.datasets",
        ),
        _spec(
            "run_model_validation",
            "model",
            "Run deterministic predictive model validation.",
            "artifact_write",
            "model:run",
            "molecule_ranker.validation.models",
        ),
        _spec(
            "run_benchmark",
            "evaluation",
        ...
        _codex_spec(
            ...
            "Summarize a source-backed biologic candidate.",
            "molecule_ranker.codex_backbone.provider.CodexBackboneProvider",
        ),
        _codex_spec(
            "explain_antibody_liabilities",
            "Explain antibody sequence, novelty, and developability liabilities.",
            "molecule_ranker.codex_backbone.provider.CodexBackboneProvider",
        ),
        _codex_spec(
            "draft_biologics_review_questions",
            "Draft expert review questions for biologics candidates.",
            "molecule_ranker.codex_backbone.provider.CodexBackboneProvider",
        ),
        _codex_spec(
            "summarize_antigen_context",
            "Summarize source-backed antigen context.",
            "molecule_ranker.codex_backbone.provider.CodexBackboneProvider",
        ),
        _codex_spec(
            "draft_biologics_campaign_summary",
            "Draft a high-level biologics campaign summary.",
            "molecule_ranker.codex_backbone.provider.CodexBackboneProvider",
        ),
    ]
