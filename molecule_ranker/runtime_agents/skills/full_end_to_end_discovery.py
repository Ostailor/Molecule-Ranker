...
class FullEndToEndDiscoverySkillRequest(BaseModel):
    """Inputs for the V2.7 full end-to-end discovery runtime skill."""
...
FULL_END_TO_END_DISCOVERY = RuntimeSkillSpec(
    ...
    description="Run the governed V2.7 full discovery loop and generate an auditable bundle.",
...
def run_full_end_to_end_discovery_skill(
    ...
    *,
    ...
    """Execute the runtime skill through the deterministic V2.7 e2e runner."""
